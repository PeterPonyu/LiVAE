...
class AgentParameters(BaseModel):
    """Parameters for the LiVAE agent"""
    ...
    irecon: float = Field(default=0.0, ge=0.0, description="Interpretable reconstruction weight")
    lorentz: float = Field(default=0.0, ge=0.0, description="Lorentz distance weight") 
    beta: float = Field(default=1.0, ge=0.0, description="KL divergence weight")
    ...
    i_dim: int = Field(default=2, gt=0, description="Interpretable latent dimension")
